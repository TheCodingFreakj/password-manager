...
setup(name='passwordmanager',
      ...
      download_url='https://github.com/TheCodingFreakj/password-manager/archive/refs/tags/LassPass3.tar.gz',
      author='Pallavi Priyadarshini',
      author_email='pallavidapriya75@gmail.com',
      license='MIT',
      # packages=[ 'password-manager' ],
      packages=find_packages('passwordmanager'),
